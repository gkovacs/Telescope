...
PostsNeedclicksController = PostsListController.extend({
  view: 'needclicks'
})

PostsMostcommentsController = PostsListController.extend({
  view: 'mostcomments'
})

PostsMostviewsController = PostsListController.extend({
  view: 'mostviews'
})

PostsMostclicksController = PostsListController.extend({
  view: 'mostclicks'
})
...
Meteor.startup(function () {
  ...
  Router.route('/needclicks/:limit?', {
    name: 'posts_needclicks',
    controller: PostsNeedclicksController
  });

  Router.route('/mostcomments/:limit?', {
    name: 'posts_mostcomments',
    controller: PostsMostcommentsController
  });

  Router.route('/mostviews/:limit?', {
    name: 'posts_mostviews',
    controller: PostsMostviewsController
  });

  Router.route('/mostclicks/:limit?', {
    name: 'posts_mostclicks',
    controller: PostsMostclicksController
  });
