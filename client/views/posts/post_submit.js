    ...
    before: {
      submitPost: function(doc, template) {
        ...
        if (typeof(disablepostchecks) == 'undefined' || !disablepostchecks) {
          ...
          if (doc.url.indexOf('http://crowdresearch.stanford.edu') != 0 && doc.url.indexOf('http://github.com') != 0 && doc.url.indexOf('https://github.com') != 0 && doc.url.indexOf('http://www.github.com') != 0 && doc.url.indexOf('https://www.github.com') != 0 && doc.url.indexOf('http://trello.com') != 0 && doc.url.indexOf('https://trello.com') != 0 && doc.url.indexOf('http://www.trello.com') != 0 && doc.url.indexOf('https://www.trello.com') != 0) {
